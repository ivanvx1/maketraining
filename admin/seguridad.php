...
<a href="index.php" title="Regresar al panel de administración"><img src="../themes/simplicio/direction_left.png" width="48" height="48" /></a><a href="seguridad.php?action=upload" title="+ Subir un nuevo archivo"><img src="../themes/simplicio/notification_add.png" width="48" height="48" /></a><br />
...
<?php if ($_GET[action]==='editar') {
	...
	if (substr($row[nombre],-4) === ".jpg" || substr($row[nombre],-4) === ".JPG") $img=jpg;
		...
		echo '<img src="/make-training/themes/default/images/ext/'.$img.'.png" alt="'.$img.'" width="64" height="64" /><h2 class="title">'.$row[nombre].'</h2><form action="seguridad.php" method="POST">
...
else if ($_POST[action]==='edit-do')
{
	...
	<form enctype="multipart/form-data" action="seguridad.php" method="POST">
...
`ID`,`nombre`,`descripcion`,`curso`,`fecha`) VALUES (NULL , '$var','$_POST[descripcion]','1','$date');");
    }
